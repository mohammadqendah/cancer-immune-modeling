...
The notebook/Modeling Project.ipynb notebook and the app.py dashboard act as an in-silico clinical trial, testing 6 distinct hypotheses:

Baseline Immunoclearance (Healthy Patient)

Systemic Immunosuppression

Indolent/Slow-Growing Tumors

Late-Stage Diagnosis (Immune Exhaustion)

Immunotherapy Rescue (Boosting Kill Rate)

Immune Evasion ("Cold" Tumors)
...
Bash
git clone https://github.com/mohammadqendah/cancer-immune-modeling.git
